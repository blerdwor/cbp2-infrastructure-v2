...
public:
    ...
    UINT8 loop_pred; // The prediction returned for current PC

    void init();
    UINT8 get_pred(unsigned int pc);
    void update_entry(bool taken, UINT8 tage_pred);
};
...
uint8_t LoopPred::get_pred(unsigned int pc)
{
    hit = -1;
